...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($admin && password_verify($password, $admin['password'])) {
        if (($admin['status'] ?? 'active') === 'suspended') {
            ...
            $error = "Access denied. Only Superadmin can login here.";
        } else {
...
<head>
    ...
    <style>
        ...
        body, .login-card, .prestige-input { transition: background-color 0.3s ease, border-color 0.3s ease, color 0.3s ease !important; }
        [data-theme="dark"] body { background-color: #060c18 !important; }
        [data-theme="dark"] .login-card { background: #111827 !important; border-color: rgba(255,255,255,0.07) !important; box-shadow: 0 20px 50px rgba(0,0,0,0.5) !important; }
        [data-theme="dark"] .login-header { background: #0f172a !important; border-bottom-color: rgba(255,255,255,0.07) !important; }
        [data-theme="dark"] .login-header h3 { color: #e2e8f0 !important; }
        [data-theme="dark"] .login-header p { color: #6b7280 !important; }
        [data-theme="dark"] .brand-logo { background: #0a1020 !important; border-color: #f59e0b !important; color: #f59e0b !important; }
        ...
        [data-theme="dark"] .prestige-input::placeholder { color: #374151 !important; }
        [data-theme="dark"] .input-icon { color: #4b5563 !important; }
        [data-theme="dark"] .btn-primary { background: #f59e0b !important; border-color: #f59e0b !important; color: #0f172a !important; }
        [data-theme="dark"] .btn-primary:hover { background: #d97706 !important; box-shadow: 0 8px 20px rgba(245,158,11,0.3) !important; }
        [data-theme="dark"] .alert { background: rgba(239,68,68,0.1) !important; border-color: rgba(239,68,68,0.2) !important; color: #f87171 !important; }
        [data-theme="dark"] .footer-text { color: #4b5563 !important; }
        [data-theme="dark"] .footer-text a { color: #94a3b8 !important; }
        [data-theme="dark"] .footer-text a:hover { color: #f59e0b !important; }
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <h3 class="serif-font">Superadmin Portal</h3>
            ...
            <div class="login-body">
                ...
                <form action="" method="POST">
                    <div>
                        <label class="form-label">Superadmin Username</label>
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password" id="password" class="prestige-input" placeholder="••••••••"
